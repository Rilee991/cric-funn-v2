...
const SubscribedTournaments = () => {
    ...
    return (
        <div>
            {[1,2,3,4,5].map(e => (
                <div className="tw-mb-4 tw-w-full tw-p-4 tw-text-center tw-bg-gray-300 tw-border tw-rounded-lg tw-shadow-md sm:tw-p-8">
                    ...
                    <div className="tw-items-center tw-justify-center tw-space-y-4 sm:tw-flex sm:tw-space-y-0 sm:tw-space-x-4">
                        <a href="#" className="tw-w-full sm:tw-w-auto tw-bg-gray-800 hover:tw-bg-gray-900 focus:tw-ring-4 focus:tw-outline-none focus:tw-ring-gray-300 tw-text-white tw-rounded-lg tw-inline-flex tw-items-center tw-justify-center tw-px-4 tw-py-2.5">
            ...
            {series.map(e => (
                <div className={`tw-mb-4 tw-w-full tw-p-4 tw-text-center tw-bg-gradient-to-r ${e.from} ${e.to} tw-border tw-rounded-lg tw-shadow-md sm:tw-p-8`}>
