...
const Home = () => {
    ...
    const subscribedTabClassNames = activeTab === tournamentTypes.SUBSCRIBED ? "tw-text-gray-900" : "tw-text-gray-400";
    const activeTabClassNames = activeTab === tournamentTypes.ACTIVE ? "tw-text-gray-900" : "tw-text-gray-400";
