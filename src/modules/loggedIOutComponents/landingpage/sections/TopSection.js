    ...
    return (
        <div className="tw-grid tw-max-w-screen-xl tw-px-4 tw-py-8 tw-mx-auto lg:tw-gap-8 xl:tw-gap-0 lg:tw-py-16 lg:tw-grid-cols-12">
            <div className="tw-mr-auto tw-place-self-center lg:tw-col-span-7">
                <h1 className="tw-max-w-max tw-mb-4 tw-text-4xl tw-font-extrabold tw-tracking-tight tw-leading-none md:tw-text-5xl xl:tw-text-6xl tw-text-white">Participate in series and compete against the best minds in the realm of betting.</h1>
